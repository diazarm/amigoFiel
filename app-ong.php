                ...
                <div class="container container-fluid text-center ">
                    <div class="row">
                        <div class="col-12 mb-4 mt-2">
                            ...
                            <h1 class="bg-light p-1 w-auto"> Bienvenido + nombre</h1>
                            <img src="assets/images/app-ong.jpg" class=" w-100 img-fluid " style="object-fit: contain;"alt="" >      
                        </div>
                    </div>
                    <div class="col-6 placeholder-wave ">
                        ...
                        <a href="ingreso-ong.php"class="btn btn-primary d-block mt-3  btn-height">
                            <div class="d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="col-6 placeholder-wave">
                        <a href="ingreso-voluntario.php"class="btn btn-danger d-block  btn-height">
                            <div class="d-flex flex-column justify-content-center align-items-center">
                                <img src="assets/images/sirena400.png" width="100px" height="100px" style="object-fit: contain;" alt="">
                                <h6 class="text-light">SOS</h6>
                            </div>
                        </a> 
                        <a href="ong.php"class="btn btn-warning mt-3 d-block mt-1 btn-height">  
                            <div class="d-flex flex-column justify-content-center align-items-center">
