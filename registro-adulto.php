...
<body>
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-4 m-auto">
                <img src="assets/images/registro-adulto.jpg"  alt="reg-image"
                class="img-fluid text-center w-auto mt-2 mb-3"/>
                <h4 class="text-center ">Registro Adultos</h4>
                ...
                <form id='form'>
                    ...
                    <input class="form-control mt-2" placeholder="DNI.." type="number" name="dni">
    ...
    <script src="assets/js/registroAdulto.js"></script>
</body>
</html>